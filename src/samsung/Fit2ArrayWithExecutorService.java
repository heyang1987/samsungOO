...
public class Fit2ArrayWithExecutorService {
    ...
    public static void main(String args[]) throws Exception {
		...
		for (int i = 0; i < 200; i++) {
			...
			Runnable worker = new MyRunnable(cf, instanceArray);
        ...
        BufferedWriter writer1 = new BufferedWriter(new FileWriter("./docs/data/Fit2profile1_"+cf+".arff"));
        writer1.write(finalData1.toString());
        writer1.flush();
        writer1.close();
        BufferedWriter writer2 = new BufferedWriter(new FileWriter("./docs/data/Fit2profile2_"+cf+".arff"));
	...
	public static class MyRunnable implements Runnable {
		...
		MyRunnable(String cf, ArrayList<Instances> instanceArray) {
            this.cf = cf;
